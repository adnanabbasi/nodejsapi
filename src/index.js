...
app.all('*', (req, res) => res.status(HttpStatus.NOT_FOUND.code, HttpStatus.NOT_FOUND.status)
    .send(new Response(HttpStatus.NOT_FOUND.code, HttpStatus.NOT_FOUND.status, 'Route does not eixst on the server')));
